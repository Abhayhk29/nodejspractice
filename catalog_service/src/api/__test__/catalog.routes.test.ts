// super test will mimick the express app

import request from 'supertest';
import express from 'express';

import { faker } from '@faker-js/faker';
import catalogRoutes, { catalogServices } from "../catalog.routes";
...
describe("Catalog Routes", () => {
    ...
    //   test.skip("should create product successfully", async () => {
    //     const requestBody = mockRequest();
    //     const product = ProductFactory.build()
    //     jest
    //       .spyOn(catalogServices, "createProduct")
    ...
    //   test.skip("should response with validation error 400", async () => {
    //     const requestBody = mockRequest();
    //     const response = await request(app)
    //       .post("/products")
    ...
    //   test.skip("should response with an internal error code 500", async () => {
    //     const requestBody = mockRequest();
    //     jest
    //       .spyOn(catalogServices, "createProduct")
    ...
    //     };
    //     jest
    //       .spyOn(catalogServices, "updateProduct")
    //       .mockImplementationOnce(() => Promise.resolve(product));
    //     const response = await request(app)
    ...
    describe("GET /products?limit=0&offset=0", () => {
      test("should return a range of products based on limit and offset", async () => {
        ...
        jest
          .spyOn(catalogServices, "getProducts")
    ...
    describe("GET /products/:id", () => {
      test("should return a product by id", async () => {
        const product = ProductFactory.build();
        jest
          .spyOn(catalogServices, "getProduct")
          .mockImplementationOnce(() => Promise.resolve(product));
        const response = await request(app)
    ...
    describe("DELETE /products/:id", () => {
      test("should delete a product by id", async () => {
        const product = ProductFactory.build();
        jest
          .spyOn(catalogServices, "deleteProduct")
